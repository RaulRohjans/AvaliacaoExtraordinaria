...
namespace AvalExt_Backoffice
{
    public partial class Form_Edit_Al : Form
    {
        ...
        private void Form_Edit_UtilizadorAl_Load(object sender, EventArgs e)
        {
                                    ...
                                    if (txt_morada.Text != "")
                                    {
                                        if (txt_turma.Text != "")
                                        {
                                            if(txt_pass1.Text != "" && txt_pass2.Text != "")
                                            {
                                                if(txt_pass1.Text == txt_pass2.Text)
                                                {
                                                    dal.editAluno(cbb_users.Text, dal.sha256(txt_pass1.Text), txt_nome.Text, dtp_.Value.ToShortDateString(), txt_cont.Text, txt_morada.Text, null, txt_turma.Text);
                                                    this.Close();
                                                }
                                                else
                                                {
                                            ...
                                            else
                                            {
                                                if(txt_pass1.Text == "" && txt_pass2.Text == "")
                                                {
                                                    dal.editAluno(cbb_users.Text, null, txt_nome.Text, dtp_.Value.ToShortDateString(), txt_cont.Text, txt_morada.Text, null, txt_turma.Text);
                                                    this.Close();
                                                }
                                                else
                                                {
