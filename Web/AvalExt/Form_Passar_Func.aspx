<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_Passar_Func.aspx.cs" Inherits="AvalExt.Form_Passar_Func" %>
...
<head runat="server">
    ...
    <title>Transferir Professor - Avaliações Extraordinárias</title>
    ...
    <form runat="server">
        <div class="wrapper">
            ...
            <div class="card mb-15">
                <div class="card-body">
                    <h4 class="card-title">Atribuir Professor</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="mb-15">
                                    <label>Pedido</label>
                                    <asp:DropDownList ID="cbb_pedido" class="btn dropdown-toggle btn-light form-control" runat="server" OnSelectedIndexChanged="cbb_pedido_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                </div>
                            ...
                            <div class="mb-15">
                                ...
                                <br/>
                                <asp:Button ID="btn_ok" class="btn btn-primary" runat="server" Text="Alterar Professor" OnClick="btn_ok_Click" />
                        ...
                        <div class="col-md-6">
                                ...
                                <div style="margin-top: 20px;" class="mb-15" id="div_labels" runat="server">
                                    <p><b>Aluno: </b></p>
                                    <p><b>Professor: </b></p>
                                    <p><b>M&#243dulo: </b></p>
                                    <p><b>Data Cria&#231&#227o: </b></p>
                                </div>                                                           
