<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_AL_Dashboard.aspx.cs" Inherits="AvalExt.Form_AL_Dashboard" %>
...
<head runat="server">
    ...
    <title>Inicio Aluno - Avaliações Extraordinárias</title>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card border border-primary">
                            <div class="card-body">
                                <h5 class="card-title">Percisa de marcar uma avaliação?</h5>
                                <p class="card-text">Carregue no botão abaixo para se redirecionar à página para registar o pedido.</p>
                                <asp:Button CssClass="btn btn-primary" Text="Marcar Avaliação" runat="server" ID="btn_marcar" OnClick="btn_marcar_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border border-info">
                            <div class="card-body">
                                <h5 class="card-title">Quer consultar as suas marcações?</h5>
