<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_Cancelar_PedidoFunc.aspx.cs" Inherits="AvalExt.Form_Cancelar_PedidoFunc" %>
...
<head runat="server">
    ...
    <title>Cancelar Pedido - Avaliações Extraordinárias</title>
    ...
    <form runat="server">
        <div class="wrapper">
            ...
            <div class="card mb-15">
                <div class="card-body">
                    <h4 class="card-title">Cancelar Pedido</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <br/>
                                <asp:Button ID="btn_ok" class="btn btn-primary" runat="server" Text="Cancelar Pedido" OnClick="btn_ok_Click" />
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="mb-15" id="div_labels" runat="server">
                                    <p><b>Aluno: </b></p>
                                    <p><b>Professor: </b></p>
                                    <p><b>M&#243dulo: </b></p>
