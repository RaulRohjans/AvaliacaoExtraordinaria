<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_ConsultarProf.aspx.cs" Inherits="AvalExt.Form_ConsultarProf" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="mb-15">
                                    ...
                                    <asp:RadioButton style="margin-left: 15px;" ID="rdb_aval" runat="server" GroupName="modo" OnCheckedChanged="rdb_aval_CheckedChanged" AutoPostBack="true"/>
                                    <label style="margin-left: 3px;">Avaliar</label>    
                                </div>
