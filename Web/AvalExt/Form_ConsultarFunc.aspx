<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_ConsultarFunc.aspx.cs" Inherits="AvalExt.Form_ConsultarFunc" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="mb-15">
                                    ...
                                    <asp:RadioButton style="margin-left: 15px;" ID="rdb_aprov" runat="server" GroupName="modo" OnCheckedChanged="rdb_aprov_CheckedChanged" AutoPostBack="true"/>
                                    <label style="margin-left: 3px;">Aprovar</label>    
                                    <asp:RadioButton style="margin-left: 15px;" ID="rdb_preco" runat="server" GroupName="modo" OnCheckedChanged="rdb_preco_CheckedChanged" AutoPostBack="true"/>
                                    <label style="margin-left: 3px;">Atribuir Pre&#231o</label>    
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="mb-15">
                                    ...
                                    <label style="margin-left: 25px;">Aluno:</label>
                                    <asp:DropDownList ID="cbb_al" width="150px" class="btn dropdown-toggle btn-light" runat="server" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-md-6">                            
                                ...
                                <div id="div_button" runat="server">
